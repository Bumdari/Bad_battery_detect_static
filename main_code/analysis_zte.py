...
data_folder = 'data_zte'
OUTPUT_FILE  = 'output_analysis_zte.xlsx'
...
for filename in all_files:
    ...
    try:
        ...
        if current_level == 'CRITICAL':
            ...
            forecast_str = f"{current_level} ↘ CRITICAL орчим ({near_critical_date})"
        ...
        results.append({
            'ip address'               : ip,
            'site location': df['site_location'].iloc[0], 
